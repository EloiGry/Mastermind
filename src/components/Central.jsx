                ...
                <Droppable key={list} droppableId={list} direction='horizontal'>
                    {(provided, snapshot) => (
                        <Container
                            ...
                            {state[list].length === 4 && <button className='absolute bottom-[3.5em] right-[5em] md:right-4 md:bottom-2  border-2 border-white text-white px-3 py-1 rounded-lg' onClick={() => handleClick()}> Valider </button>}
                        </Container>
                    )}
                </Droppable>
            );
